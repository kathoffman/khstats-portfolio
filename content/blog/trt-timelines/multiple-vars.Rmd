...
An R code walkthrough for making customizable treatment timelines or "swimmer plots" for longitudinal data when you have multiple treatments or statuses you want to show. These types of plots can help visualize treatment or measurement patterns, time-varying covariates, outcomes, and loss to follow-up in longitudinal data settings.
...
You can view a corresponding slide deck I made for the 2022 R/Medicine [[here]](https://kathoffman.github.io/swimmer-plots/slides.html#1).
